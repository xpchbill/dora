import { CloseButton, CloseButtonProps } from '@ALK-UI/close-button';
import { FocusLock } from '@ALK-UI/focus-lock';
import { useSafeLayoutEffect } from '@ALK-UI/hooks';
import { Portal, PortalProps } from '@ALK-UI/portal';
import {
  chakra,
  PropsOf,
  ThemingProps,
